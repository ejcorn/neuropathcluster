...
ggsave(filename = paste(savedir,'LassoClusterFeatureWeights',extralab,'.pdf',sep=''),plot = p1,
...
ggsave(filename = paste(savedir,'LassoTraditionalDiseaseFeatureWeights',extralab,'.pdf',sep=''),plot = p2,
       height = 5,width=7,units='cm')